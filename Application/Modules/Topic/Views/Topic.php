...
?> 
    ...
    <div  class="main">
        <div style="float:left; width: 700px;">
            <div style="padding:10px 0;"><h1 style=" font-size: 30px; padding: 20px 0 5px; font-weight: normal;"><a style="color:#333; " href="<?php echo topic_url($topic['id'], $topic['url']);?>"><?php echo $topic['title'];?></a></h1></div>
