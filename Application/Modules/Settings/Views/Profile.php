    ...
    <div  class="main">
        ...
        <div class="uside" style="position: fixed;">
            ...
            <div style=" background: #eee; width: 198px; border: 1px solid #EEE; margin-bottom: 10px; padding: 10px 0; min-height: 500px;">
                <h1 style=" margin-top: 20px; font-size: 24px; font-family: 微软雅黑; font-weight: normal; padding-left: 30px;">设置</h1>
                <ul style=" padding-left: 35px; font-size: 14px;">
                    <li style="line-height:30px;"><a href="/user/message">个人资料</a></li>
                    <li style="line-height:30px;"><a href="/user/notice">头像</a></li>
                    <li style="line-height:30px;"><a href="/user/notice">邮箱</a></li>
                </ul>
            </div>
