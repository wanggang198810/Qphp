...
class Image {
    ...
    public static $mtime = 1383792073;

    //头像目录
    public static $avatarPath = 'avatar';
    
    //背景图目录
    public static $backImagePath = 'backimage';
    
    //背景图目录
    public static $audioIntrPath = 'audio';
    
    //允许上传图片
    public static $imageType = Array('jpg', 'jpeg', 'png', 'gif');
    
    //允许上传音频
    public static $audioType = Array('avi', 'mp3', 'amr');
    
    //头像允许图片大小 单位Kb
    public static $avatarUploadSize = 1024;
    
    //背景图允许图片大小
    public static $backImageUploadSize = 2048;
    ...
    //背景图尺寸
    public static $backImageSize = array(
        0 => array('width'=>300,'height'=>100),
    );
    ...
    public function setPath($url){
        ...
        unset($path[$count-1]);
        //$bathPath = ROOT_PATH.'/data/avatar';
        foreach($path as $k => $v){
            $imagePath .= $v.'/';
            if(!is_dir($v)){
                mkdir($v, '0777');
